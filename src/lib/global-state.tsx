...
import { getAllReservations, getFullWaitlist, getWaitlist, isWaitlistPaused, getRestaurant } from './supabase-data'
...
export function GlobalStateProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Subscribe to reservations changes - no filter, we'll filter client-side
    ...
    // Subscribe to waitlist changes - no filter, we'll filter client-side
  ...
  }, [refreshReservations, refreshWaitlist, restaurantId])
